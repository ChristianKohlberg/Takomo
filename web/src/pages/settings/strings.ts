...
export const DOCUMENT_APPEARANCE_STRINGS = {
  en: {
      ...
      numbering: { title: 'Section numbers', h1: 'Show H1 numbers', h2: 'Show H2 numbers', size: 'Number size (% of heading)', help: 'Project defaults. Numbers inherit the heading color; readers can change visibility for themselves in the document toolbar.' },
  ...
  de: {
      ...
      numbering: { title: 'Abschnittsnummern', h1: 'H1-Nummern anzeigen', h2: 'H2-Nummern anzeigen', size: 'Nummerngröße (% der Überschrift)', help: 'Projektvorgaben. Nummern übernehmen die Überschriftenfarbe; Leser können die Sichtbarkeit in der Dokumentleiste für sich ändern.' },
