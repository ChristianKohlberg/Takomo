...
const STR = defineStrings({
  en: {
    ...
    collaborativeWarning: 'This clears the summary, every section and its prose, comments, attachments, relationships and agent proposals. The document and mindmap share this content, so both views will be cleared. Title, status, metadata, existing revision history and linked tickets and behaviors remain. Connected editors receive the reset.',
    initiativeWarning: 'This clears the summary and all entries, views, notes, amendments, discussions, proposals and attachments. The document keeps its title, folder, metadata, status, labels and tags. Linked tickets remain.',
  ...
  de: {
    ...
    collaborativeWarning: 'Dies löscht Zusammenfassung, alle Abschnitte samt Text, Kommentare, Anhänge, Beziehungen und Agentenvorschläge. Dokument und Mindmap teilen diese Inhalte: Beide Ansichten werden geleert. Titel, Status, Metadaten, vorhandene Versionshistorie und verknüpfte Tickets und Verhalten bleiben erhalten. Verbundene Editoren erhalten die Änderung.',
    initiativeWarning: 'Dies löscht die Zusammenfassung und alle Einträge, Ansichten, Notizen, Änderungsanträge, Diskussionen, Vorschläge und Anhänge. Titel, Ordner, Metadaten, Status, Labels und Tags bleiben erhalten. Verknüpfte Tickets bleiben bestehen.',
