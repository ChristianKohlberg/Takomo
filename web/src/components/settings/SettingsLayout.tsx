  ...
  return <div className="settings-surface">
    ...
    <div className="settings-body">
      <aside id="settings-sidebar" className={`settings-sidebar ${open ? 'is-open' : ''}`}>
        ...
        <nav aria-label={de ? 'Instanzverwaltung' : 'Instance administration'}><div className="settings-caption">{de ? 'Instanzverwaltung' : 'Instance administration'}</div>{nav(['people', 'access', 'projects', 'library', 'search', 'data'])}</nav>
